    ...
    <div class="flex items-center justify-center w-full h-screen">
        <div class="flex flex-col  items-center justify-center">
            ...
            <div class="border border-primary-700 rounded-lg shadow-primary-300 shadow-lg py-4 px-8 w-full">
                ...
                <div>
                    <div class="mb-4">
                        <label for="name" class="block text-primary-700 text-sm font-bold mb-2">
                            نام
                        </label>
                    ...
                    <div class="mb-4">
                        <label for="last-name" class="block text-primary-700 text-sm font-bold mb-2">
                            نام خانوادگی
                        </label>
                    ...
                    <div class="mb-4">
                        <label for="password" class="block text-primary-700 text-sm font-bold mb-2">
                            کلمه عبور
                        </label>
